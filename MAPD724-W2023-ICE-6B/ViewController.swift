...
//
//  Created by Raziel Hernandez on 2023-03-10.
//
...
class ViewController: UIViewController, UIImagePickerControllerDelegate,
    ...
    @IBAction func takePictureOrVideo_Pressed(_ sender: UIButton) {
        print("take a new picture")
        pickMediaFromSource(.camera)
    }
    
    @IBAction func SelectExistingPicture_Pressed(_ sender: UIButton) {
        print("select existing picture")
